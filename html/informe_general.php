<form class="form-horizontal " action="" rol="form" id="form_informe" method="post">
  <div class="" id="tab_informe">
    ...
    <div class="navegar">
      <ul  class="devian">
        <li class="active"><a href="#tab_general" data-toggle="tab"><span class="glyphicon glyphicon-th"></span> Datos Generales</a></li>
        <li><a href="#tab2" data-toggle="tab"><span class="glyphicon glyphicon-list-alt"></span> Ingreso de Proveedores</a></li>
        <li><a href="#tab3" data-toggle="tab"><span class="glyphicon glyphicon-th"></span> Tipos de Usuarios</a></li>
        <li><a href="#tab4" data-toggle="tab"><span class="glyphicon glyphicon-th"></span> Cálculo de Precios</a></li>
      </ul>
    </div>  
  </div>
</form>
